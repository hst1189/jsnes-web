    ...
    (function ($) {
        $.fn.JSNESUI = function (roms) {
            ...
            var UI = function (nes) {
                ...
                self.romSelect = $('<select class="nes-roms-select"></select>').appendTo(self.romContainer);
                ...
                setRoms: function (roms) {
                    ...
                    for (var groupName in roms) {
                        if (roms.hasOwnProperty(groupName)) {
                            ...
                            for (key in roms[groupName]) {
                                $('<option>' + key + '</option>').attr("value", roms[groupName][key]).appendTo(optgroup);
                            }
